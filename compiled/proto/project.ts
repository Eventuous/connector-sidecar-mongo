...
function createBaseInsertOne(): InsertOne {
  return { $type: "projection.InsertOne", document: undefined };
}

export const InsertOne = {
  $type: "projection.InsertOne" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): InsertOne {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInsertOne();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: InsertOne): unknown {
    const obj: any = {};
    message.document !== undefined && (obj.document = message.document);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<InsertOne>, I>>(
    object: I
  ): InsertOne {
    const message = createBaseInsertOne();
...
messageTypeRegistry.set(InsertOne.$type, InsertOne);

function createBaseUpdateOne(): UpdateOne {
  return {
    $type: "projection.UpdateOne",
    filter: undefined,
    update: undefined,
...
export const UpdateOne = {
  $type: "projection.UpdateOne" as const,
  ...
  encode(
    ...
    if (message.filter !== undefined) {
      Struct.encode(
        Struct.wrap(message.filter),
        writer.uint32(10).fork()
      ).ldelim();
    }
    if (message.update !== undefined) {
      Struct.encode(
        Struct.wrap(message.update),
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UpdateOne {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateOne();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.filter = Struct.unwrap(
            Struct.decode(reader, reader.uint32())
          );
          break;
        case 2:
          message.update = Struct.unwrap(
            Struct.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  toJSON(message: UpdateOne): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateOne>, I>>(
    object: I
  ): UpdateOne {
    const message = createBaseUpdateOne();
...
messageTypeRegistry.set(UpdateOne.$type, UpdateOne);

function createBaseDeleteOne(): DeleteOne {
  return { $type: "projection.DeleteOne", filter: undefined };
}

export const DeleteOne = {
  $type: "projection.DeleteOne" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeleteOne {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteOne();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: DeleteOne): unknown {
    const obj: any = {};
    message.filter !== undefined && (obj.filter = message.filter);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<DeleteOne>, I>>(
    object: I
  ): DeleteOne {
    const message = createBaseDeleteOne();
    message.filter = object.filter ?? undefined;
...
messageTypeRegistry.set(DeleteOne.$type, DeleteOne);
